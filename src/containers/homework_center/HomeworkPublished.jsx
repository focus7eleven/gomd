/**
 * Moded by qq from HomeworkLibPage.jsx on 2017/2/8.
 */
...
const HomeworkPublished = React.createClass({
    ...
    getTableHeader() {
        let tableHeader = fromJS([
            ...
            //{title: '附件', dataIndex: 'gradeName', key: 'gradeName'},

            //{title: '详细', dataIndex: 'term', key: 'term'},

            {title: '批改状态', dataIndex: 'status', key: 'status'}
            //{title: '批阅结果', dataIndex: 'textbook_version', key: 'textbook_version'}
        ]);
