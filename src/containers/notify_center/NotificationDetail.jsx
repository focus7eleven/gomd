...
import {Row,Col,Input,Button,Modal,Tree,Icon} from 'antd';

import config from '../../config';
import {ROLE_STUDENT} from '../../constant';
import {baseURL} from '../../config';
import styles from './NotificationDetail.scss';
...
const NotificationDetail = React.createClass({
    contextTypes: {
    ...
    componentWillMount() {
        //获取通知详情
        this.getNotifyDetail(this.props.params.notificationId , this.props.userInfo.userId);
    },
    ...
    getNotifyDetail(notificationId, userId){
        fetch(config.api.notify.showNotificationUrl(notificationId, userId), {
            method:'get',
            headers:{
                'from':'nodejs',
            ...
            this.setState({
                ...
                createTime:convertDateToString(notification.notificationContent.createDate,"yyyy-MM-dd hh:mm"),
                creatorusername:notification.notificationContent.createUserName ,
                content: notification.notificationContent.content ,
                selectedgrouparray:notification.groups,
            })
        })
