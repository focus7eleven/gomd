...
const CourseCenterContainer = React.createClass({
  ...
  render(){
    return this.props.courseCenter.get('loadingDetail') || this.props.menu.get('data').isEmpty()?<div className={styles.loading}><Spin size="large" /></div>:this.props.children
  }
})
