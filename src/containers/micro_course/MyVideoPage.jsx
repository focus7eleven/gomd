...
import styles from './MyVideoPage.scss'
...
const MyVideoPage = React.createClass({
  getInitialState(){
    return {
      searchStr:'',
      currentTab: "hot",
  ...
  handleSearchVideo(value){
    this.props.getTableData('private',value,this.props.microCourse.get('data').get('nowPage'));
  },
  ...
  handlePageChanged(pageNumber){
    this.props.getTableData('private','',pageNumber);
  },
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles.right}>
            <VideoFilterComponent pageType="private"></VideoFilterComponent>
              ...
              <div className={styles.videoPanel}>
                {
                  data.get('result').map((item,index)=>{
                    ...
                    return <div key={index}>
                      <VideoComponent pageType="myvideo" description={description} videoUrl={item.get('url')} coverUrl={item.get('coverUrl')} id={item.get('id')}></VideoComponent>
                    </div>
                  })
                }
              </div>
...
export default connect(mapStateToProps,mapDispatchToProps)(MyVideoPage)
